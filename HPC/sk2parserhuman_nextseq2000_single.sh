...
/hpc/hub_kops/bin/bwa aln -q 0 -n 0.04 -k 2 -l 200 -t 4 -B 11 /hpc/hub_kops/GRCh38.p10.genome.clean.fa *$A*_R1_001.fastq > $A-output/$A-R1.sai

/hpc/hub_kops/bin/bwa samse /hpc/hub_kops/GRCh38.p10.genome.clean.fa $A-output/$A-R1.sai *$A*_R1_001.fastq > $A-output/$A-R1.sam
